      ...
      <div className="relative min-h-screen pt-24 pb-32 overflow-hidden bg-black text-white">
        ...
        <div className="container relative z-10">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            >
              {/* AI Core Status Card */}
              <div className="relative w-full border border-white/20 bg-black overflow-hidden group p-6">
              ...
              <div className="border border-white/20 bg-black p-6 aspect-square flex flex-col">
